...
from pygame import font, mixer, sprite, transform, image, display, time, key, event, KEYDOWN, K_LEFT, K_RIGHT, K_SPACE, QUIT
...
img_back = resource_path("galaxy.jpg") # game background
 
img_bullet = resource_path("bullet.png") # bullet
img_hero = resource_path("rocket.png") # character
img_enemy = resource_path("ufo.png") # enemy
